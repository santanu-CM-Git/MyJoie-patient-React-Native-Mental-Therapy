    ...
    return (
        <SafeAreaView style={styles.Container}>
            ...
            <ScrollView style={styles.wrapper}>
                ...
                {activeTab == 'Upcoming' ?
                    <View style={{ width: responsiveWidth(89), backgroundColor: '#FFF', padding: 20, borderRadius: 20, marginTop: responsiveHeight(2), marginBottom: responsiveHeight(2), elevation: 5, alignSelf: 'center' }}>
